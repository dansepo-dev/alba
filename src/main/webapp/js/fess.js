...
$(function(){
    // (1) Fess の URL
    var baseUrl = "https://fess.wh.local/json/?q=";
      ...
      if(searchQuery.length != 0) {
        ...
        $.ajax({
          ...
          if(record_count == 0) { // (11) 検索結果がない場合
            ...
            offset = startRange - 1;
            // (13) サブヘッダーに出力
            buf.push("<b>", dataResponse.q, "</b> の検索結果 ", record_count, " 件中 ", startRange, " - ",
            ...
            for(i = 0, max = results.length; i < max; i++) {
              buf = [];
              buf.push('<li><h3 class="title">', '<a href="', results[i].url_link, '">', results[i].title,
